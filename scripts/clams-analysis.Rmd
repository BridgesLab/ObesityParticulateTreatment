...
#comparison of saline and cabosil groups
VO2.light.aov.lean.ctl <- aov(Light.raw~Lean+Particulate.Treatment, data=subset(annotated.data.o2, Particulate.Treatment!='MCP'))
summary(VO2.light.aov.lean.ctl)

VO2.dark.aov.lean.ctl <- aov(Dark.raw~Lean+Particulate.Treatment, data=subset(annotated.data.o2, Particulate.Treatment!='MCP'))
summary(VO2.dark.aov.lean.ctl)

heat.light.aov.lean.ctl <- aov(Light.raw~Lean+Particulate.Treatment, data=subset(annotated.data.heat, Particulate.Treatment!='MCP'))
summary(heat.light.aov.lean.ctl)

heat.dark.aov.lean.ctl <- aov(Dark.raw~Lean+Particulate.Treatment, data=subset(annotated.data.heat, Particulate.Treatment!='MCP'))
summary(heat.dark.aov.lean.ctl)

activity.light.aov.ctl <- aov(Light~Particulate.Treatment, data=subset(Activity.data.annotated, Particulate.Treatment!='MCP'))
summary(activity.light.aov.ctl)

activity.dark.aov.ctl <- aov(Dark~Particulate.Treatment, data=subset(Activity.data.annotated, Particulate.Treatment!='MCP'))
summary(activity.dark.aov.ctl)
